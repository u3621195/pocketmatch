...
function applyTheme(id) {
  ...
  document
    ...
    .forEach((el) => el.classList.toggle("active", el.dataset.theme === id));
}
...
const LANDMARK_SPRITES = [
  {
    id: 1,
    n: "Acropolis of Athens",
    img: "assets/sprites/landmarks/01-acropolis-of-athens.png",
  },
  { id: 2, n: "Big Ben", img: "assets/sprites/landmarks/02-big-ben.png" },
  {
    id: 3,
    n: "Christ the Redeemer",
    img: "assets/sprites/landmarks/03-christ-the-redeemer.png",
  },
  { id: 4, n: "Colosseum", img: "assets/sprites/landmarks/04-colosseum.png" },
  {
    id: 5,
    n: "Eiffel Tower",
    img: "assets/sprites/landmarks/05-eiffel-tower.png",
  },
  {
    id: 6,
    n: "Golden Gate Bridge",
    img: "assets/sprites/landmarks/06-golden-gate-bridge.png",
  },
  {
    id: 7,
    n: "Grand Palace",
    img: "assets/sprites/landmarks/07-grand-palace.png",
  },
  {
    id: 8,
    n: "Great Pyramid of Giza",
    img: "assets/sprites/landmarks/08-great-pyramid-of-giza.png",
  },
  {
    id: 9,
    n: "Great Wall of China",
    img: "assets/sprites/landmarks/09-great-wall-of-china.png",
  },
  {
    id: 10,
    n: "Kinderdijk Windmill",
    img: "assets/sprites/landmarks/10-kinderdijk-windmill.png",
  },
  { id: 11, n: "Las Vegas", img: "assets/sprites/landmarks/11-las-vegas.png" },
  {
    id: 12,
    n: "Leaning Tower of Pisa",
    img: "assets/sprites/landmarks/12-leaning-tower-of-pisa.png",
  },
  {
    id: 13,
    n: "Louvre Museum",
    img: "assets/sprites/landmarks/13-louvre-museum.png",
  },
  {
    id: 14,
    n: "Marina Bay Sands",
    img: "assets/sprites/landmarks/14-marina-bay-sands.png",
  },
  { id: 15, n: "Merlion", img: "assets/sprites/landmarks/15-merlion.png" },
  {
    id: 16,
    n: "Mount Fuji",
    img: "assets/sprites/landmarks/16-mount-fuji.png",
  },
  {
    id: 17,
    n: "Mount Rushmore",
    img: "assets/sprites/landmarks/17-mount-rushmore.png",
  },
  {
    id: 18,
    n: "Neuschwanstein Castle",
    img: "assets/sprites/landmarks/18-neuschwanstein-castle.png",
  },
  {
    id: 19,
    n: "Palm Jumeirah",
    img: "assets/sprites/landmarks/19-palm-jumeirah.png",
  },
  {
    id: 20,
    n: "Sheikh Zayed Grand Mosque",
    img: "assets/sprites/landmarks/20-sheikh-zayed-grand-mosque.png",
  },
  {
    id: 21,
    n: "St. Peter's Basilica",
    img: "assets/sprites/landmarks/21-st-peter-s-basilica.png",
  },
  {
    id: 22,
    n: "Statue of Liberty",
    img: "assets/sprites/landmarks/22-statue-of-liberty.png",
  },
  {
    id: 23,
    n: "Stonehenge",
    img: "assets/sprites/landmarks/23-stonehenge.png",
  },
  {
    id: 24,
    n: "Swiss Alps",
    img: "assets/sprites/landmarks/24-swiss-alps.png",
  },
  {
    id: 25,
    n: "Sydney Harbour Bridge",
    img: "assets/sprites/landmarks/25-sydney-harbour-bridge.png",
  },
  {
    id: 26,
    n: "Sydney Opera House",
    img: "assets/sprites/landmarks/26-sydney-opera-house.png",
  },
  { id: 27, n: "Taj Mahal", img: "assets/sprites/landmarks/27-taj-mahal.png" },
  {
    id: 28,
    n: "The United States Capitol",
    img: "assets/sprites/landmarks/28-the-united-states-capitol.png",
  },
  {
    id: 29,
    n: "Tower Bridge",
    img: "assets/sprites/landmarks/29-tower-bridge.png",
  },
  {
    id: 30,
    n: "White House",
...
function createBoard() {
  let values = [],
    active = entities.slice(0, (ROWS * COLS) / 2);
  for (let i = 0; i < (ROWS * COLS) / 2; i++) {
    let e = active[i % active.length];
    values.push(e, e);
  }
  shuf(values);
  board = [];
...
function clickTile(r, c, el) {
  ...
  if (board[a.r][a.c].entity.id === board[b.r][b.c].entity.id) {
    ...
    moveStatus.textContent = "DIFFERENT CREATURES";
    sfx.invalid();
  }
  clearSel();
}
...
function updateBoardInfo() {
  ...
  if (!board || !board.length) {
    boardInfoEl.textContent = "MATCHES: --";
    return;
  }
...
function showLevelComplete() {
  ...
  levelScore += timeBonus + perfect;
  setScoreDisplay();
  const nextSetName = isQuickGame
    ? "Random tile set"
    : (SPRITE_SETS[currentSpriteSetId] || SPRITE_SETS.original).name;
  $("lcKicker").textContent =
    `LEVEL ${String(level).padStart(2, "0")} COMPLETE`;
...
function setupPauseModal() {
  ...
  if (isQuickGame) {
    ...
    if (msg)
      msg.textContent =
        "Quick Game is a single-session mode and will not save progress.";
    ...
    if (msg)
      msg.textContent =
        "The timer is stopped. Choose how you want to continue.";
